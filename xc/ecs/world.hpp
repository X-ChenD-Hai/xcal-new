...
class World {
   ...
   public:
    ...
    // bottom layer component action
    inline ComponentInfo& component_info(component_t comp) noexcept {
        XC_ASSERT(has_component(comp));
        return component_infos_[pool_index_of_component(comp)];
    }
    void attach_component(component_t comp, Entity e, void* data);
    void detach_component(component_t comp, Entity e);
    void modify_component(component_t comp, Entity e, void* data);
