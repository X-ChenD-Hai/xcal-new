...
#ifdef _DEBUG
#define XC_ON_DEBUG(...) __VA_ARGS__
#else
#define XC_ON_DEBUG(...)
#endif

#define XC_TDBG(...) XC_ON_DEBUG(XC_TLOG(__VA_ARGS__))
#define XC_DBG(...) XC_ON_DEBUG(XC_LOG(__VA_ARGS__))
#define XC_INFO(...) XC_LOG(INFO, __VA_ARGS__)
#define XC_WARN(...) XC_LOG(WARN, __VA_ARGS__)
#define XC_ERR(...) XC_LOG(ERROR, __VA_ARGS__)
#define XC_TINFO(...) XC_TLOG(INFO, __VA_ARGS__)
#define XC_TWARN(...) XC_TLOG(WARN, __VA_ARGS__)
#define XC_TERR(...) XC_TLOG(ERROR, __VA_ARGS__)