...
void draw_elements(DrawMode mode, size_t count, BufferTarget target,
                   const void* indices);

void draw_arrays_instanced(DrawMode mode, int32_t first, size_t count,
                           size_t instance_count);

void draw_elements_instanced(DrawMode mode, size_t count, BufferTarget target,
                             const void* indices, size_t instance_count);
